...
const generateInvoice = (order, res) => {
  ...
  doc
    ...
    .text(`Date: ${new Date(order.createdAt).toLocaleDateString()}`, 200, 80, {
      align: "right",
    })
    .moveDown()
  ...
  order.products.forEach((item) => {
    ...
    doc
      ...
      .text(`Rs. ${lineTotal.toLocaleString()}`, 470, y, {
        width: 80,
        align: "right",
      })
    y += 20
  ...
  doc
    ...
    .text(`Rs. ${subtotal.toLocaleString()}`, 470, y, {
      width: 80,
      align: "right",
    })
  y += 20
  ...
  if (order.discountAmount > 0) {
    doc
      ...
      .text(`-Rs. ${order.discountAmount.toLocaleString()}`, 470, y, {
        width: 80,
        align: "right",
      })
    y += 20
  ...
  doc
    ...
    .text(`Rs. ${order.totalPrice.toLocaleString()}`, 470, y, {
      width: 80,
      align: "right",
    })
  ...
  doc
    .fontSize(10)
    .fillColor("#444444")
    .text("Thank you for shopping with Crochella Store!", 50, 700, {
      align: "center",
    })
