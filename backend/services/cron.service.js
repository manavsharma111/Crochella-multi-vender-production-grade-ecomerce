...
const startCronJobs = () => {
    cron.schedule('0 21 * * *', async () => {
        ...
        try {
            ...
            console.log(`Total ${abandonedCarts.length} carts found in which items are left. Sending reminders`)
            for (const cart of abandonedCarts) {
                ...
                await sendPushAlert(
                    ...
                    "Hey " + user.name + ", your handloom saree is waiting in your cart. Order it before someone else grabs it!"
                )
    ...
    console.log("Cron job set to run at 9 pm everyday to send reminders for abandoned carts")
}
