...
router.post('/custom/toggle', authMiddleware, wishlistController.toggleProductInCustomWishlist)

// get all custom wishlists
router.get('/custom', authMiddleware, wishlistController.getCustomWishlists)

// delete custom wishlist
router.delete('/custom/:customWishlistId', authMiddleware, wishlistController.deleteCustomWishlist)

// update custom wishlist
router.put('/custom/:customWishlistId', authMiddleware, wishlistController.updateCustomWishlist)
