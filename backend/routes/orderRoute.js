...
router.get('/all-orders', authMiddleware, adminMiddleware, orderController.getAllOrdersAdmin)

// Get single order
router.get('/:id', authMiddleware, orderController.getOrder)

// Handle refund and stock update
router.put('/:id/refund', authMiddleware, adminMiddleware, orderController.handleRefundAndStock)
...
router.put('/:id/cancel-not-deliver', authMiddleware, orderController.cancelOrderNotDeliver)
