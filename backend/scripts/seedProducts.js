...
const seedProducts = async () => {
  try {
    ...
    const categories = ["Wraps", "Coats", "Sarees", "Tunics", "Gowns", "Dresses", "Scarves", "Jackets"]
    const materials = ["Pure Silk", "Cashmere", "Organic Cotton", "Silk Velvet", "Linen", "Pashmina", "Chiffon"]
    const weaves = ["Handwoven", "Hand-stitched", "Jacquard Handloom", "Plain Weave", "Handcrafted", "Embroidered"]
    const images = [
    ...
    const adjectives = ["Midnight", "Artisan", "Golden", "Heritage", "Crimson", "Royal", "Vintage", "Eternal", "Celestial", "Luminous", "Classic"]
    ...
    for (let i = 1; i <= 25; i++) {
      ...
      fakeProducts.push({
        ...
        price: price,
        discountPrice: hasDiscount ? price - Math.floor(Math.random() * 2000) - 500 : 0,
