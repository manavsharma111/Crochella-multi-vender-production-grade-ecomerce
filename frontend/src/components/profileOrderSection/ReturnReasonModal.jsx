...
const ReturnReasonModal = ({ isOpen, onClose, onSubmit, paymentMethod }) => {
  ...
  const handleSubmit = async () => {
    ...
    const finalReason =
      selectedReason === "Other" ? `Other: ${comments}` : selectedReason
        ...
        >
          ...
          >
            <p className="text-gray-400 text-sm mb-4">
              Please let us know why you are returning this item so we can
            ...
            <div className="space-y-2 mb-5 pr-2">
              {REASONS.map((reason) => (
                ...
                >
                  ...
                  >
                    {selectedReason === reason && (
                      <div className="w-2.5 h-2.5 rounded-full bg-[#ff007f]"></div>
                    )}
                  </div>
                  <span
                    className={`font-bold ${selectedReason === reason ? "text-white" : "text-gray-400"}`}
                  >
                    {reason}
                  </span>
                </label>
