  ...
  return (
    <div className="flex flex-col gap-6 sticky top-24">
      ...
      <div className="bg-linear-to-br from-white/10 to-white/5 p-4 rounded-2xl border border-white/20 backdrop-blur-md relative overflow-hidden group">
        ...
        <div className="flex items-start justify-between relative z-10">
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-xs mt-1 max-w-[200px] leading-relaxed">
                ...
                <a
                  href="#"
                  className="text-white underline hover:text-[#ff007f]"
                >
                  Learn More.
                </a>
              </p>
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            >
              <div
                className={`w-4 h-4 rounded-full bg-white transition-transform ${insuranceEnabled ? "translate-x-6" : "translate-x-0"}`}
              ></div>
            </button>
      ...
      <div className="bg-linear-to-b from-[#111] to-[#0a0a0a] p-6 rounded-2xl border border-white/10 shadow-2xl relative overflow-hidden">
        ...
        <h2 className="text-white font-black text-xl uppercase tracking-widest mb-6">
          Order Summary
        </h2>
        ...
        <div className="space-y-3 mb-6 text-sm font-bold tracking-wide">
          ...
          <div className="flex justify-between items-center text-lg">
            ...
            <span className="text-[#ff007f] font-black text-2xl">
      ...
      <div className="bg-[#111] p-6 rounded-2xl border border-white/5">
        ...
        <p className="text-gray-500 text-xs leading-relaxed">
          We're confident we design and sell the very best premium apparel
          available at an affordable price, and we want you to share our
          confidence! That's why we back every sale with a 30-day money back
          guarantee.
        </p>
      </div>
