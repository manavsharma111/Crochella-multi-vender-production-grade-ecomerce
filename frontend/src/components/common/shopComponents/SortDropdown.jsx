...
const SortDropdown = ({ sortOption, setSortOption, isSortOpen, setIsSortOpen }) => {
  return (
    <div className="relative shrink-0 z-40">
      ...
      >
        Sort <ChevronDown size={12} className={`md:w-3.5 md:h-3.5 transition-transform duration-300 ${isSortOpen ? 'rotate-180' : ''}`} />
      </button>
