...
const AdminSidebar = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <>
      ...
      <div
        className={`w-64 h-screen bg-[#0a0a0a] border-r-2 border-gray-800 flex flex-col fixed left-0 top-0 z-50 transform ${isOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 transition-transform duration-300`}
      >
        {/* Logo */}
