  ...
  if (!isAuthenticated) {
    return (
      <div className="bg-[#111] border-2 border-gray-800 rounded-2xl p-6 text-center">
        ...
        <p className="text-gray-400 text-sm mb-4">You must be logged in to share your experience.</p>
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
        <div>
          <label className="block text-xs text-gray-500 font-bold uppercase tracking-widest mb-2">Your Rating</label>
          <StarRating rating={rating} setRating={setRating} size={28} />
        </div>

        <div>
          <label className="block text-xs text-gray-500 font-bold uppercase tracking-widest mb-2">Your Review</label>
          <textarea
            value={comment}
