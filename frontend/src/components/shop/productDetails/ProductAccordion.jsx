...
const ProductAccordion = ({ product }) => {
  ...
  const accordionData = [
    ...
    },
    {
      ...
      content: (
        <ul className="space-y-2 list-disc pl-4 marker:text-[#ff007f]">
          ...
          <li>
            <span className="text-white font-bold">Weave Type:</span>{" "}
            {product.weaveType}
          </li>
          <li>
    ...
    },
    {
      ...
      content:
        "Dry clean only. Do not bleach. Keep away from direct sunlight to preserve colors and fabric integrity.",
    },
    {
      title: "Shipping & Returns",
      content:
        "Free standard shipping on orders over ₹10,000. Express delivery available. 30-day return policy for unused items with original tags.",
    },
  ]
  return (
