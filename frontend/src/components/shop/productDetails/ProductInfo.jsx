...
const ProductInfo = ({ product }) => {
  ...
  const displayNumReviews =
    totalReviews > 0 ? totalReviews : product.numReviews || 0
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="flex items-end gap-3 pb-6 border-b border-white/5"
      >
      ...
      <motion.div
        variants={itemVariants}
        className="mt-6 pt-6 border-t border-white/5 grid grid-cols-1 sm:grid-cols-2 gap-4"
      >
      ...
      >
        ...
        <p className="text-xs text-gray-500 font-serif">
          ...
          {product.category}, {product.material}, {product.weaveType}
        </p>
      </motion.div>
    </motion.div>
  )
