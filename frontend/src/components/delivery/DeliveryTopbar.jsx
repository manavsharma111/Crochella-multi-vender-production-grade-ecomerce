...
const PAGE_TITLES = {
    '/delivery/dashboard': { title: 'Corchella Delivery Boy Dashboard', emoji: '🛒' },
...
const DeliveryTopbar = ({ isCollapsed, setIsMobileOpen }) => {
    ...
    return (
        <header className={`fixed top-0 left-0 right-0 ${isCollapsed ? 'lg:left-20' : 'lg:left-64'} z-20 bg-[#0a0a0a]/95 backdrop-blur-sm border-b-2 border-gray-800 shadow-[0_4px_30px_rgba(0,0,0,0.5)] transition-all duration-300`}>
            <div className="flex items-center justify-between px-4 md:px-6 h-16">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <h1 className="text-base font-black text-white tracking-wide">{page.title}</h1>
                        </div>
                        <p className="text-xs text-gray-500 hidden sm:block font-bold">{dateStr} &bull; {timeStr}</p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2 md:gap-3">
                    ...
                    <div className="relative sm:static" ref={dropdownRef}>
                        ...
                        >
                            <Bell size={19} className="text-gray-400 hover:text-white transition-colors" />
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <div className="hidden sm:block text-left">
                                <p className="text-xs font-black text-white leading-tight max-w-[90px] truncate">{shortName}</p>
                                <p className="text-[10px] text-[#ff007f] font-bold uppercase tracking-wider leading-tight">Delivery Partner</p>
                            </div>
                            <ChevronDown size={14} className={`text-gray-500 transition-transform hidden sm:block ${dropdownOpen ? 'rotate-180' : ''}`} />
                        </button>
                                ...
                                <>
                                    ...
                                    >
                                        ...
                                        <div className="px-4 py-4 bg-[#111] border-b border-gray-800">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="min-w-0">
                                                    <p className="text-sm font-black text-white truncate">{user?.name || 'Delivery Boy'}</p>
                                                    <p className="text-[10px] text-[#ff007f] font-bold uppercase tracking-widest">Delivery Partner</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="px-4 py-3 flex items-center gap-2 border-b border-gray-800 bg-[#0a0a0a]">
                                            ...
                                            <span className="text-xs text-gray-400 font-bold uppercase tracking-wider">Currently On Duty</span>
                                        </div>
