    ...
    <>
      ...
      >
        <div className="bg-[#0a0a0a] border-r-2 border-gray-800 shadow-md h-full flex flex-col">
          {/* Logo */}
          <div
            className={`flex items-center justify-between p-5 border-b-2 border-gray-800 ${isCollapsed ? "justify-center" : ""}`}
          >
              ...
              <AnimatePresence initial={false}>
                {!isCollapsed && (
                  ...
                  >
                    ...
                    <p className="text-xs text-[#ff007f] font-bold">
                      Dashboard
                    </p>
                  </motion.div>
                )}
          ...
          {/* User Profile */}
          <div
            className={`p-4 border-b-2 border-gray-800 ${isCollapsed ? "px-3" : "px-6"}`}
          >
            <div
              className={`flex gap-3 ${isCollapsed ? "justify-center" : "items-center"}`}
            >
              ...
              {MENU_ITEMS.map((item) => (
                ...
                >
                  <NavLink
                    ...
                    onClick={() => setIsMobileOpen(false)}
                    className={({ isActive }) =>
                      `flex items-center gap-3 py-3 rounded-xl font-bold transition-all duration-200 ${isCollapsed ? "justify-center px-2" : "px-4"} ${
                        isActive
          ...
          {/* Footer */}
          <div
            className={`border-t-2 border-gray-800 p-4 ${isCollapsed ? "px-3" : "px-6"} space-y-2 relative`}
          >
            <button
