              ...
              {loading ? (
                ...
                orderList.map((order) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-3 py-1 rounded-full border text-xs font-black uppercase tracking-widest inline-block ${getStatusColor(order.orderStatus)}`}
                      >
                        {order.orderStatus}
                      </span>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      ...
                      <p className="text-[10px] text-[#ff007f] font-bold tracking-widest uppercase mt-1">
