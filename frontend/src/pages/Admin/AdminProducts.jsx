              ...
              {isLoading ? (
                ...
                filteredProducts.slice(0, visibleCount).map((product) => {
                  ...
                  return (
                    <tr
                      key={product._id}
                      className="border-b border-gray-800 hover:bg-[#111]/50 transition-colors"
                    >
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-4">
                          ...
                          product.media[0].type === "video" ? (
                            <video
                              src={media}
                              className="w-12 h-12 rounded-lg object-cover border border-gray-700 bg-black"
                              muted
                            />
                          ) : (
                            <img
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`font-bold ${product.stock <= 5 ? "text-red-500" : "text-[#00ff88]"}`}
                        >
                          {product.stock || 0}
                        </span>
                      </td>
