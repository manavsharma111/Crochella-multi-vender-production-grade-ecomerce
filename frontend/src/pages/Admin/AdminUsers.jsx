              ...
              {loading ? (
                ...
                users.map((u) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`inline-flex items-center gap-1 px-3 py-1 rounded-full border text-xs font-black uppercase tracking-widest ${
                          u.role === "admin"
                            ? "bg-[#ff007f]/10 text-[#ff007f] border-[#ff007f]"
                            : u.role === "seller"
                      ...
                      {u.role === "delivery_boy" &&
                        u.deliveryRating?.average > 0 && (
                          <div className="flex items-center gap-1 mt-2 text-yellow-500 text-xs font-bold bg-yellow-500/10 w-fit px-2 py-0.5 rounded border border-yellow-500/20">
                            ⭐ {u.deliveryRating.average.toFixed(1)} / 5.0 (
                            {u.deliveryRating.count})
                          </div>
                        )}
                    </td>
