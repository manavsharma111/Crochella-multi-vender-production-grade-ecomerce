...
const MyDeliveries = () => {
  ...
  const returnPickups = myDeliveries.filter(
    (o) => o.deliveryStatus === "Return_Pickup",
  )
  const completed = myDeliveries.filter((o) =>
    ["Delivered", "Return_Collected"].includes(o.deliveryStatus),
  )
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          <div>
            ...
            <p className="text-gray-600 mt-1 text-sm">
              {myDeliveries.length} total assignments
            </p>
          </div>
          <button
                ...
                {activeDeliveries.map((order, i) => (
                  ...
                  >
                    <div className="flex items-center justify-between px-5 pt-5 pb-3 border-b border-gray-50">
                      ...
                      <span
                        className={`px-2.5 py-1 rounded-full text-xs font-bold ${statusColors[order.deliveryStatus]}`}
                      >
                    ...
                    <div className="px-5 py-4 space-y-3">
                      ...
                      <div className="flex items-center gap-1 text-sm font-bold text-gray-700">
                        ...
                        <span className="ml-2 px-1.5 py-0.5 bg-gray-100 text-[10px] uppercase text-gray-500 rounded font-black tracking-widest">
                  ...
                  <button
                    onClick={() =>
                      setVisibleCompletedCount((prev) =>
                        Math.min(prev + 6, completed.length),
                      )
                    }
