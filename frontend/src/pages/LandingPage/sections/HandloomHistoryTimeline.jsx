    ...
    >
      ...
      <div className="text-center mb-32 relative z-10">
        ...
        <h1 className="text-5xl md:text-8xl font-serif font-black tracking-tighter">
          THE LEGACY OF WOVEN AIR
        </h1>
        <p className="mt-6 max-w-2xl mx-auto opacity-70 text-lg">
          A 5,000-year journey from ancient looms to modern luxury.
        </p>
      </div>
        ...
        {timelineEvents.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Text Block */}
              <div
                className={`w-full md:w-1/2 flex flex-col ${isEven ? "md:items-start md:text-left md:pl-24" : "md:items-end md:text-right md:pr-24"}`}
              >
                <span className="text-[#ff007f] font-serif text-3xl md:text-5xl italic mb-4">
                  {item.year}
                </span>
