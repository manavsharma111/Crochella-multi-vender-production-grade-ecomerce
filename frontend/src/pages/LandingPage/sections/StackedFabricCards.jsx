...
const StackedFabricCards = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full h-screen bg-[#050505] overflow-hidden flex justify-center items-center cursor-none"
    >
        ...
        {cards.map((card, index) => (
          ...
          >
            ...
            <div className="w-full md:w-1/2 h-full flex flex-col justify-between z-10">
              <div>
                <p className="text-sm tracking-[0.3em] uppercase opacity-60 mb-4 font-semibold">
                  {card.subtitle}
                </p>
                <h2 className="text-5xl md:text-7xl font-serif tracking-tighter leading-none mb-6">
                  {card.title}
                </h2>
                <p className="text-lg md:text-xl font-light opacity-80 max-w-md">
                  {card.desc}
                </p>
              </div>
