    ...
    <section className="w-full bg-[#050505] text-[#FAF9F6] py-32 px-6 md:px-12 cursor-none">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16">
        ...
        <div className="w-full lg:w-1/3">
          <h2 className="text-sm tracking-[0.3em] uppercase opacity-50 mb-6 text-[#ff007f]">The Hands Behind The Loom</h2>
          <h1 className="text-5xl md:text-7xl font-serif font-black tracking-tighter mb-8 leading-tight">MASTER ARTISANS</h1>
          <p className="opacity-70 text-lg leading-relaxed max-w-sm">
            Our fabrics are not born in factories. They are born in the homes of masters who have inherited their craft through centuries of oral tradition. Meet the souls of Crochella.
          </p>
          <div className="mt-12">
            <button 
              data-magnetic="true"
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 w-full h-full flex flex-col justify-end pb-8">
                  <div className={`flex items-end justify-between px-4 md:px-8 transition-transform duration-500 ${isActive ? 'translate-y-0' : 'translate-y-4'}`}>
                    <div>
                      <h3 className={`font-serif tracking-tighter transition-all duration-500 ${isActive ? 'text-4xl md:text-6xl text-[#ff007f]' : 'text-2xl md:text-4xl opacity-50'}`}>
                        {artisan.name}
                      </h3>
                      <p className={`text-sm tracking-widest uppercase mt-2 transition-opacity duration-500 ${isActive ? 'opacity-100' : 'opacity-0'}`}>
                        {artisan.role}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className={`px-4 md:px-8 overflow-hidden transition-all duration-700 ${isActive ? 'max-h-40 mt-6 opacity-80' : 'max-h-0 mt-0 opacity-0'}`}>
