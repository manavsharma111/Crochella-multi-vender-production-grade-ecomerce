...
const ArtisanCraftsmanship = () => {
  ...
  return (
    <section ref={containerRef} className="relative w-full bg-black py-32 px-6 md:px-12 flex items-center justify-center">
      <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-center">
        ...
        {/* Right Text */}
        <div ref={textRef} className="flex flex-col justify-center gap-8 text-[#FFFDD0]">
          ...
          <p className="text-lg md:text-xl text-gray-400 font-light leading-relaxed max-w-lg">
            Every thread tells a story. Our master artisans spend weeks weaving a single garment, 
            preserving centuries-old techniques while creating modern luxury. The slight imperfections 
            are the hallmark of true human touch.
          </p>
