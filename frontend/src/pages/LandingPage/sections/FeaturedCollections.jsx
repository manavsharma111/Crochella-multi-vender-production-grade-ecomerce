...
const collections = [
  { id: 1, title: "The Royal Weave", img: "https://images.pexels.com/photos/1018911/pexels-photo-1018911.jpeg" },
  { id: 2, title: "Midnight Silk", img: "https://images.pexels.com/photos/298863/pexels-photo-298863.jpeg" },
  { id: 3, title: "Golden Heritage", img: "https://images.pexels.com/photos/852860/pexels-photo-852860.jpeg" }
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {collections.map((item, i) => (
            ...
            >
              ...
              <h3 className="text-2xl font-serif text-[#FFFDD0] group-hover:text-white transition-colors">{item.title}</h3>
              <p className="text-gray-500 uppercase tracking-widest text-xs mt-2">Explore</p>
            </div>
          ))}
        </div>
      </div>
