...
const TextRevealPhilosophy = () => {
  ...
  return (
    <section ref={containerRef} className="relative w-full min-h-screen bg-[#050505] flex items-center justify-center cursor-none">
      <div ref={innerRef} className="absolute inset-0 w-full h-full flex flex-col items-center justify-center px-6 py-32">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <p
            ...
            style={{
              backgroundImage: "linear-gradient(to right, #FFFDD0 50%, rgba(255, 255, 255, 0.1) 50%)",
              backgroundSize: "200% 100%",
              backgroundPositionX: "100%"
            }}
          >
            We believe that true luxury takes time. Every thread is a silent witness to hours of patient craftsmanship, woven by hands that carry generations of heritage. We do not just make clothes; we weave legacies.
          </p>
        </div>
      </div>
    </section>
