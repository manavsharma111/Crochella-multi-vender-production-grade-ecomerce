...
const ProcessTimeline = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full bg-[#050505] py-32 px-6 flex flex-col items-center border-t border-white/5"
    >
      <div className="text-center mb-24">
        <h2 className="text-3xl md:text-5xl font-serif text-[#FFFDD0] mb-4">
          The Creation
        </h2>
      ...
      <div className="relative max-w-4xl w-full">
        ...
        <div
          ref={lineRef}
          className="absolute left-1/2 top-0 w-[2px] bg-[#FFFDD0] -translate-x-1/2 origin-top"
        ></div>
          ...
          {processSteps.map((step, i) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`w-1/2 ${isLeft ? "pr-12 md:pr-24 text-right" : "pl-12 md:pl-24 text-left"}`}
                >
                  ...
                  <h3 className="text-2xl font-serif text-[#FFFDD0] mb-4 relative z-10">
                    {step.title}
                  </h3>
