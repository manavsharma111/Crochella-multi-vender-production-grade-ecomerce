...
const lookbookItems = [
  { img: "https://images.pexels.com/photos/298863/pexels-photo-298863.jpeg", title: "THE ARCHIVE" },
  { img: "https://images.pexels.com/photos/1018911/pexels-photo-1018911.jpeg", title: "ROYAL WEAVE" },
  { img: "https://images.pexels.com/photos/852860/pexels-photo-852860.jpeg", title: "GOLDEN ERA" },
  { img: "https://images.pexels.com/photos/4590215/pexels-photo-4590215.jpeg", title: "ARTISAN" }
];
...
const HorizontalLookbook = () => {
  ...
  return (
    <section ref={containerRef} className="w-full h-screen overflow-hidden bg-[#050505] flex items-center cursor-none">
