...
const Footer = () => {
  ...
  return (
    <footer
      ref={containerRef}
      className="w-full bg-[#050505] text-white pt-24 md:pt-32 pb-8 relative overflow-hidden cursor-none border-t border-white/10 rounded-t-[2.5rem] md:rounded-t-[4rem] z-20 shadow-[0_-20px_50px_rgba(0,0,0,0.5)]"
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-20 md:mb-32">
          ...
          <div className="md:col-span-2 flex flex-col justify-between">
            <h3 className="text-3xl md:text-4xl lg:text-5xl font-serif text-[#FFFDD0] leading-tight mb-8 flex flex-wrap gap-x-2 md:gap-x-3">
              {"Redefining luxury through neo-brutalist craftsmanship."
                .split(" ")
                .map((word, index) => (
                  <span
                    key={index}
            ...
            <div className="text-gray-500 text-[10px] md:text-xs tracking-widest uppercase flex gap-4 items-center">
              ...
              <span className="flex items-center gap-1">
                Designed & Developed by Manav Sharma.{" "}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-white hover:text-[#ff007f] transition-colors underline decoration-white/20 underline-offset-4"
                >
                  Contact him.
                </a>
              </span>
          ...
          <div className="flex flex-col gap-6">
            <h4 className="text-gray-600 text-[10px] tracking-[0.2em] uppercase font-bold mb-2">
              Navigation
            </h4>
            {[
              ...
              <Link
                ...
                to={item.path}
                data-magnetic="true"
                className="w-fit text-sm md:text-base text-gray-300 hover:text-[#ff007f] cursor-none transition-colors duration-300 flex items-center gap-2 group"
              >
                {item.name}
                <ArrowUpRight
                  size={14}
                  className="opacity-0 -translate-y-2 translate-x-2 group-hover:opacity-100 group-hover:translate-y-0 group-hover:translate-x-0 transition-all duration-300"
                />
              </Link>
            ))}
          </div>
          ...
          <div className="flex flex-col gap-8 justify-between">
            <div>
              <h4 className="text-gray-600 text-[10px] tracking-[0.2em] uppercase font-bold mb-4">
                Socials
              </h4>
              <div className="flex flex-col gap-4">
                {[
                  ...
                  <a
                    ...
                    key={item.name}
                    data-magnetic="true"
                    className="w-fit text-sm md:text-base text-gray-300 hover:text-[#FFFDD0] cursor-none transition-colors duration-300 group flex overflow-hidden relative"
                  >
                    ...
                    <span className="absolute left-0 top-0 inline-block transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] translate-y-full group-hover:translate-y-0 text-[#FFFDD0]">
                      {item.name}
                    </span>
                  </a>
                ))}
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10 gap-4 md:gap-0">
          ...
          <div className="flex gap-8 text-gray-500 text-[10px] tracking-[0.2em] uppercase">
            <span
              data-magnetic="true"
              className="hover:text-white cursor-none transition-colors"
            >
              Privacy Policy
            </span>
            <span
