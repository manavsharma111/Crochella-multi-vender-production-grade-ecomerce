        ...
        >
          <div className="overflow-hidden flex gap-4 md:gap-8 justify-center flex-wrap">
            {text1.map((word, i) => (
              <span
                key={`t1-${i}`}
                className="overflow-hidden inline-block pb-4"
              >
          ...
          <div className="overflow-hidden flex gap-4 md:gap-8 justify-center flex-wrap mt-4">
            {text2.map((word, i) => (
              ...
              >
                <span
                  className="hero-word inline-block text-3xl md:text-[5rem] xl:text-[7rem] font-light italic text-white/80 tracking-tight leading-none origin-bottom-left uppercase"
