  ...
  const [notifications, setNotifications] = useState([
    {
      id: 1,
      title: 'Order Shipped',
      message: 'Your Handloom Silk Saree order has been shipped and is on the way.',
      time: '2 hours ago',
      read: false
    },
    {
    ...
    },
    {
      id: 3,
      title: 'Special Offer',
      message: 'Get 20% off on all new arrivals this weekend. Use code WEAVE20.',
      time: '3 days ago',
      read: true
    }
  ]);
  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 border-b border-white/10 pb-4">
        <h3 className="text-white font-black text-2xl uppercase tracking-widest">Notifications</h3>
        <BrutalistButton 
