    ...
    if (isLoading || !productToDisplay) {
        return (
            <div className="min-h-screen pt-32 pb-20 px-4 flex flex-col items-center justify-center bg-black">
                ...
                <h2 className="text-[#FFFDD0] font-serif text-2xl uppercase tracking-widest animate-pulse">Loading Product...</h2>
            </div>
        )
    }
        ...
        <div className="min-h-screen pt-24 pb-32 lg:pb-20 px-4 sm:px-6 lg:px-8 bg-black selection:bg-white/20 selection:text-white relative z-10">
            <div className="max-w-[1400px] mx-auto">
                ...
                <motion.div
                    ...
                    className="mb-8"
                >
                    <Link to="/shop" className="inline-flex items-center gap-2 text-gray-500 hover:text-[#FFFDD0] font-serif text-xs uppercase tracking-widest transition-colors group">
