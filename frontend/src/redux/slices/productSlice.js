...
import { createProduct, getAllProducts, getProduct, updateProduct, deleteProduct, getLowStockProducts, getFlashSales, getFilterOptions } from "../../services/product.service"

// create product
export const createProductAsync = createAsyncThunk('product/createProduct', async (productData, { rejectWithValue }) => {
  try{
...
// get product
export const getProductAsync = createAsyncThunk("product/getProduct", async (id, { rejectWithValue }) => {
    try{
...
// update product
export const updateProductAsync = createAsyncThunk("product/updateProduct", async ({id, productData}, { rejectWithValue }) => {
    try{
...
// delete product
export const deleteProductAsync = createAsyncThunk("product/deleteProduct", async (id, { rejectWithValue }) => {
    try{
...
// get filter options
export const getFilterOptionsAsync = createAsyncThunk("product/getFilterOptions", async (_, { rejectWithValue }) => {
    try{
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(getFilterOptionsAsync.fulfilled, (state, action) => {
                state.isLoading = false
                state.filterOptions = action.payload || { categories: ['All'], materials: [], weaveTypes: [] }
            })
