...
export const cancelOrderNotDeliveredAsync = createAsyncThunk(
  "order/cancelOrderNotDelivered",
...
export const returnOrderAfterDeliveryAsync = createAsyncThunk(
  "order/returnOrderAfterDelivery",
...
// get live tracking
export const getLiveTrackingAsync = createAsyncThunk(
  "order/getLiveTracking",
  async (id, { rejectWithValue }) => {
    try {
...
export const sellerGetAllOrdersAsync = createAsyncThunk(
  "order/sellerGetAllOrders",
...
export const handleOrderRefundAsync = createAsyncThunk(
  "order/handleOrderRefund",
  async (id, { rejectWithValue }) => {
    try {
    ...
    updateLiveLocation: (state, action) => {
      if (state.order) {
        if (action.payload.lat && action.payload.lng) {
          ...
          state.order.currentLocation.addressString =
            action.payload.addressString
        }
