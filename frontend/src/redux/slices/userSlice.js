...
export const getDeliveryAddressAsync = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        e.response?.data?.message || "Failed to get delivery address",
      )
    }
  },
)
...
export const addDeliveryAddressAsync = createAsyncThunk(
  ...
  async (addressData, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        e.response?.data?.message || "Failed to add delivery address",
      )
    }
  },
)
...
export const updateDeliveryAddressAsync = createAsyncThunk(
  ...
  async (addressData, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        e.response?.data?.message || "Failed to update delivery address",
      )
    }
  },
)
...
export const deleteDeliveryAddressAsync = createAsyncThunk(
  ...
  async (addressIdData, { rejectWithValue }) => {
    try {
      const response = await deleteDeliveryAddress(addressIdData)
      return response
    } catch (e) {
      return rejectWithValue(
        e.response?.data?.message || "Failed to delete delivery address",
      )
    }
  },
)
...
export const getAllUsersAsync = createAsyncThunk(
  ...
  async (params = {}, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        e.response?.data?.message || "Failed to get all users",
      )
    }
  },
)
...
export const getRecommendationsAsync = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        e.response?.data?.message || "Failed to get recommendations",
      )
    }
  },
)
...
const userSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getDeliveryAddressAsync.pending, (state) => {
        state.loading = true
      })
      ...
      .addCase(addDeliveryAddressAsync.pending, (state) => {
        state.loading = true
      })
