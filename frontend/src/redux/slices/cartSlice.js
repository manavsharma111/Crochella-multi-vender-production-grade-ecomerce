...
export const addToCartAsync = createAsyncThunk(
  "cart/addToCart",
  async ({ productId, quantity, sku, customization }, { rejectWithValue }) => {
    try {
...
export const removeFromCartAsync = createAsyncThunk(
  "cart/removeFromCart",
  async ({ productId, sku, customization }, { rejectWithValue }) => {
    try {
...
export const updateQuantityAsync = createAsyncThunk(
  "cart/updateQuantity",
  async ({ productId, sku, customization, quantity }, { rejectWithValue }) => {
    try {
